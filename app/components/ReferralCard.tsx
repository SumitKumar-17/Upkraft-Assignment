const ReferralCard = () => {
    return (
        <div className="bg-[#4F46E5] text-white p-6 rounded-2xl shadow-sm flex flex-col items-center text-center">
            <img
            ...
            <p className="text-violet-200 mt-2 mb-4 text-sm max-w-xs">
                Invite friends and earn exclusive rewards for every successful referral.
            </p>
            <button className="bg-white text-violet-800 font-bold py-2 px-6 rounded-lg hover:bg-gray-100 transition-colors">
                Refer Now &rarr;
            </button>
        </div>
    );
